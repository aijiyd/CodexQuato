...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 1.3.0" "$STAGING_APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 6" "$STAGING_APP/Contents/Info.plist"
