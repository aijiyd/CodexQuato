...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 1.5.0" "$STAGING_APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 11" "$STAGING_APP/Contents/Info.plist"
