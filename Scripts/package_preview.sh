...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 1.3.1" "$STAGING_APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 7" "$STAGING_APP/Contents/Info.plist"
