...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 1.3.2" "$STAGING_APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 8" "$STAGING_APP/Contents/Info.plist"
